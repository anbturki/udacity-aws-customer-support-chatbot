...
TOOL_SCHEMA = {
    ...
    "description": (
        "File a bug ticket in the engineering team's tracker and return the "
        "new ticket's ID. "
        "PRECONDITION: call this ONLY after the customer has personally told "
        "you all three of (1) what is broken, (2) the steps they took to "
        "reproduce it, and (3) the browser, operating system, or device they "
        "were using. If you have not yet ASKED the customer for the steps or "
        "the environment, do NOT call this tool: ask them first and call it on "
        "a later turn. Never infer the steps from general knowledge of how the "
        "shop works or from the FAQ, and never pass a placeholder such as "
        "'Unknown', 'N/A', 'None' or 'Not provided'. Filing an incomplete or "
        "invented ticket is worse than asking one more question."
    ),
    "inputSchema": {
        "type": "object",
        "properties": {
            ...
            "stepsToReproduce": {
                "type": "string",
                "description": (
                    "The steps the customer said they took, in their own "
                    "words. Must come from the customer. Never inferred and "
                    "never copied from the FAQ."
                ),
            },
            "environment": {
                "type": "string",
                "description": (
                    "The browser, operating system, or device the customer "
                    "stated they were using. Must come from the customer."
                ),
            },
        },
